#
#  Be sure to run `pod spec lint Tiamo.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "Tiamo"
  spec.version      = "0.0.1"
  spec.summary      = "Tiamo is another very simple uncompleted ActiveRecord ORM For iOS."
  ...
  spec.homepage     = "https://github.com/wbitos/tiamo"
  ...
  spec.source       = { :git => "https://github.com/wbitos/tiamo.git", :tag => "#{spec.version}" }
